...
void main()
{
    ...
    //
    // (64,64) is the center of the screen
    // the ball is in the center at initialization
    //
    int x = 64;
    int y = 64;
    ...
    while(1) {
        ...
        //
        // Place the data into numx and numy
        //
        ...
        //
        // Make the numbers into negative integers
        // if they are negative in 2's complement
        //
        if (numx>127) {
            numx = numx - 256;
        }
        ...
        //
        // we divided the accelerometer data by 4 
        // because we want to slow down the movement
        //
        numx = numx/4;
        numy = numy/4;

        //
        // displacement to the current coordinates
        //
        x = x+numx;
        y = y+numy;

        //
        // saturate the x and y coordinates 
        // to stay in the range 3 < X & Y < 125
        //
        if (x<3) {
            x = 3;
        }
